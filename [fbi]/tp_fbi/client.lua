...
positions = {
    ...
    {{142.17, -768.88, 45.75, 0}, {147.23, -738.03, 242.15, 0},{36,237,157}, "FBI"}, -- Entrez , Sorti FBI 
    {{88.80, -726.80, 33.133, 0}, {139.07, -762.68, 45.75, 0},{255, 157, 0}, "Garage"}, -- Entrez , Sorti Garage
}
...
Citizen.CreateThread(function ()
    while true do
        ...
        for _,location in ipairs(positions) do
            ...
            DrawMarker(25, loc2.x, loc2.y, loc2.z, 0, 0, 0, 0, 0, 0, 1.501, 1.5001, 0.5001, Red, Green, Blue, 200, 0, 0, 0, 0)
